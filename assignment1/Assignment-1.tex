...
{{\underline{Solution:} }
Let K be the event that the student knows the answer and C be the event that the student answered the question correctly. We want to find the conditional probability $\Pr(K|C)$, which is the probability that the student knows the answer given that he answered correctly.\\
...
We can use Bayes' theorem to find $\Pr(K|C)$:

\begin{align*}
 \pr{K|C} &= \pr{C|K} \cdot \pr{\frac{C}{K}}\\
 &= \pr{C|K} \cdot \pr{\frac{K}{C|K}} \cdot \pr{K} + \pr{C|K^c} \cdot \pr{K^c}\\
 &= 1 \cdot (\frac{\frac{3}{4}} {[1 \cdot \frac{3}{4} + \frac{1}{4} \cdot \frac{1}{4}]}) \\
 &= \frac{12}{13}
\end{align*}
